...
namespace KamranWali.CodeOptPro.Managers
{
    public class MonoAdvManager_Call : MonoBehaviour, ICOPSetup<MonoAdvManager>
    {
        ...
        private void Awake()
        {
            for (_counter = 0; _counter < _managers.Length; _counter++) _managers_PreAwakeAdv_Setup[_counter].PreAwakeAdv(); // Calling pre awake adv setup to allow global variable setup
        ...
        public void ResetData() => _managers_PreAwakeAdv_Setup = new List<MonoAdvManager>();
        #endregion
    }
}